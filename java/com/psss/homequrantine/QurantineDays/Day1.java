...
public class Day1 extends AppCompatActivity {
    ...
    String feverIn, coughIn, tasteIn;
    String completedStatus,reportDB,reportIn;

    FirebaseAuth mAuth;
    FirebaseDatabase database;
    DatabaseReference ref,removeRef;
        ...
        complete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fever.getCheckedRadioButtonId() == -1 && cough.getCheckedRadioButtonId() == -1 && taste.getCheckedRadioButtonId() == -1 ) {
                    Toast.makeText(Day1.this, "Fill the self check symptoms", Toast.LENGTH_SHORT).show();
                } else if (fever.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(Day1.this, "Select your fever level", Toast.LENGTH_SHORT).show();
                } else if (cough.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(Day1.this, "Select your cough level", Toast.LENGTH_SHORT).show();
                } else if (taste.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(Day1.this, "Select your taste level", Toast.LENGTH_SHORT).show();
                } else {

                    progressDialog = new ProgressDialog(Day1.this);
                    progressDialog.setTitle("Saving your Day 1 activities");
                    ...
                    if ( ( feverIn.matches("Low") && coughIn.matches("Low") && tasteIn.matches("Low") ) ||
                        ...
                        ref.child(mAuth.getUid()).child("Day 1").setValue(qDaysDB).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                                progressDialog.dismiss();
                                removeRef.child(mAuth.getUid()).child("0").removeValue();
