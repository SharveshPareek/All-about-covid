        ...
        complete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fever.getCheckedRadioButtonId() == -1 && cough.getCheckedRadioButtonId() == -1 && taste.getCheckedRadioButtonId() == -1 ) {
                    ...
                    progressDialog.setTitle("Saving your Day 2 activities");
                    ...
                    if ( ( feverIn.matches("Low") && coughIn.matches("Low") && tasteIn.matches("Low") ) ||
                        ...
                        ref.child(mAuth.getUid()).child("Day 2").setValue(qDaysDB).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                                progressDialog.dismiss();
                                removeRef.child(mAuth.getUid()).child("1").removeValue();
